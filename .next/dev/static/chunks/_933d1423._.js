...
"[project]/lib/iap.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const SUBSCRIPTION_PRODUCT_IDS = {
    ios: 'com.vscout.app.monthly',
    android: 'premium_mensal'
};
...
const productId = SUBSCRIPTION_PRODUCT_IDS[platform] || SUBSCRIPTION_PRODUCT_IDS.ios;
let store;
 ...
 */ async function handlePurchase(purchase) {
    ...
    try {
        ...
        if (platform === 'android') {
            ...
            const receiptData = transaction.receipt || transaction.purchaseToken;
            let purchaseToken = '';
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].functions.invoke('validate-android', {
                method: 'POST',
                body: {
                    purchaseToken,
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].functions.invoke('validate-ios', {
                method: 'POST',
                body: {
...
async function initializeIAP() {
    ...
    // @ts-ignore
    await __turbopack_context__.A("[project]/node_modules/cordova-plugin-purchase/www/store.js [app-client] (ecmascript, async loader)");
    ...
    store.when().approved((transaction)=>handlePurchase(transaction));
...
async function handleSubscriptionFlow(mode) {
    if (platform === 'web') {
        return {
            success: false,
            error: 'Compras não disponíveis na web.'
        };
    }
    if (!isInitialized) {
        await initializeIAP();
    ...
    try {
        ...
        if (product?.offers && product.offers.length > 0) {
            ...
            let offer = product.offers.find((o)=>o.id === targetPlanId || o.basePlanId === targetPlanId);
            if (!offer) {
...
"[project]/components/iap-provider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$capacitor$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@capacitor/core/dist/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$iap$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/iap.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function IAPProvider({ children }) {
    _s();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "IAPProvider.useEffect": ()=>{
            const platform = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$capacitor$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Capacitor"].getPlatform();
            if (platform !== 'web') {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$iap$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initializeIAP"])();
            }
        }
    }["IAPProvider.useEffect"], []);
...
_s(IAPProvider, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = IAPProvider;
var _c;
__turbopack_context__.k.register(_c, "IAPProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_933d1423._.js.map