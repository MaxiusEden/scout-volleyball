...
"[project]/node_modules/cordova-plugin-purchase/www/store.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
(function(CdvPurchase) {
     ...
     */ let ErrorCode;
    (function(ErrorCode) {
        /** Error: Failed to intialize the in-app purchase library */ ErrorCode[ErrorCode["SETUP"] = ERROR_CODES_BASE + 1] = "SETUP";
        /** Error: Failed to load in-app products metadata */ ErrorCode[ErrorCode["LOAD"] = ERROR_CODES_BASE + 2] = "LOAD";
        /** Error: Failed to make a purchase */ ErrorCode[ErrorCode["PURCHASE"] = ERROR_CODES_BASE + 3] = "PURCHASE";
        /** Error: Failed to load the purchase receipt */ ErrorCode[ErrorCode["LOAD_RECEIPTS"] = ERROR_CODES_BASE + 4] = "LOAD_RECEIPTS";
        /** Error: Client is not allowed to issue the request */ ErrorCode[ErrorCode["CLIENT_INVALID"] = ERROR_CODES_BASE + 5] = "CLIENT_INVALID";
        /** Error: Purchase flow has been cancelled by user */ ErrorCode[ErrorCode["PAYMENT_CANCELLED"] = ERROR_CODES_BASE + 6] = "PAYMENT_CANCELLED";
        /** Error: Something is suspicious about a purchase */ ErrorCode[ErrorCode["PAYMENT_INVALID"] = ERROR_CODES_BASE + 7] = "PAYMENT_INVALID";
        /** Error: The user is not allowed to make a payment */ ErrorCode[ErrorCode["PAYMENT_NOT_ALLOWED"] = ERROR_CODES_BASE + 8] = "PAYMENT_NOT_ALLOWED";
        /** Error: Unknown error */ ErrorCode[ErrorCode["UNKNOWN"] = ERROR_CODES_BASE + 10] = "UNKNOWN";
        /** Error: Failed to refresh the purchase receipt */ ErrorCode[ErrorCode["REFRESH_RECEIPTS"] = ERROR_CODES_BASE + 11] = "REFRESH_RECEIPTS";
        /** Error: The product identifier is invalid */ ErrorCode[ErrorCode["INVALID_PRODUCT_ID"] = ERROR_CODES_BASE + 12] = "INVALID_PRODUCT_ID";
        /** Error: Cannot finalize a transaction or acknowledge a purchase */ ErrorCode[ErrorCode["FINISH"] = ERROR_CODES_BASE + 13] = "FINISH";
        /** Error: Failed to communicate with the server */ ErrorCode[ErrorCode["COMMUNICATION"] = ERROR_CODES_BASE + 14] = "COMMUNICATION";
        /** Error: Subscriptions are not available */ ErrorCode[ErrorCode["SUBSCRIPTIONS_NOT_AVAILABLE"] = ERROR_CODES_BASE + 15] = "SUBSCRIPTIONS_NOT_AVAILABLE";
        /** Error: Purchase information is missing token */ ErrorCode[ErrorCode["MISSING_TOKEN"] = ERROR_CODES_BASE + 16] = "MISSING_TOKEN";
        /** Error: Verification of store data failed */ ErrorCode[ErrorCode["VERIFICATION_FAILED"] = ERROR_CODES_BASE + 17] = "VERIFICATION_FAILED";
        /** Error: Bad response from the server */ ErrorCode[ErrorCode["BAD_RESPONSE"] = ERROR_CODES_BASE + 18] = "BAD_RESPONSE";
        /** Error: Failed to refresh the store */ ErrorCode[ErrorCode["REFRESH"] = ERROR_CODES_BASE + 19] = "REFRESH";
        /** Error: Payment has expired */ ErrorCode[ErrorCode["PAYMENT_EXPIRED"] = ERROR_CODES_BASE + 20] = "PAYMENT_EXPIRED";
        /** Error: Failed to download the content */ ErrorCode[ErrorCode["DOWNLOAD"] = ERROR_CODES_BASE + 21] = "DOWNLOAD";
        /** Error: Failed to update a subscription */ ErrorCode[ErrorCode["SUBSCRIPTION_UPDATE_NOT_AVAILABLE"] = ERROR_CODES_BASE + 22] = "SUBSCRIPTION_UPDATE_NOT_AVAILABLE";
        /** Error: The requested product is not available in the store. */ ErrorCode[ErrorCode["PRODUCT_NOT_AVAILABLE"] = ERROR_CODES_BASE + 23] = "PRODUCT_NOT_AVAILABLE";
        /** Error: The user has not allowed access to Cloud service information */ ErrorCode[ErrorCode["CLOUD_SERVICE_PERMISSION_DENIED"] = ERROR_CODES_BASE + 24] = "CLOUD_SERVICE_PERMISSION_DENIED";
        /** Error: The device could not connect to the network. */ ErrorCode[ErrorCode["CLOUD_SERVICE_NETWORK_CONNECTION_FAILED"] = ERROR_CODES_BASE + 25] = "CLOUD_SERVICE_NETWORK_CONNECTION_FAILED";
        /** Error: The user has revoked permission to use this cloud service. */ ErrorCode[ErrorCode["CLOUD_SERVICE_REVOKED"] = ERROR_CODES_BASE + 26] = "CLOUD_SERVICE_REVOKED";
        /** Error: The user has not yet acknowledged Apple’s privacy policy */ ErrorCode[ErrorCode["PRIVACY_ACKNOWLEDGEMENT_REQUIRED"] = ERROR_CODES_BASE + 27] = "PRIVACY_ACKNOWLEDGEMENT_REQUIRED";
        /** Error: The app is attempting to use a property for which it does not have the required entitlement. */ ErrorCode[ErrorCode["UNAUTHORIZED_REQUEST_DATA"] = ERROR_CODES_BASE + 28] = "UNAUTHORIZED_REQUEST_DATA";
        /** Error: The offer identifier is invalid. */ ErrorCode[ErrorCode["INVALID_OFFER_IDENTIFIER"] = ERROR_CODES_BASE + 29] = "INVALID_OFFER_IDENTIFIER";
        /** Error: The price you specified in App Store Connect is no longer valid. */ ErrorCode[ErrorCode["INVALID_OFFER_PRICE"] = ERROR_CODES_BASE + 30] = "INVALID_OFFER_PRICE";
        /** Error: The signature in a payment discount is not valid. */ ErrorCode[ErrorCode["INVALID_SIGNATURE"] = ERROR_CODES_BASE + 31] = "INVALID_SIGNATURE";
        /** Error: Parameters are missing in a payment discount. */ ErrorCode[ErrorCode["MISSING_OFFER_PARAMS"] = ERROR_CODES_BASE + 32] = "MISSING_OFFER_PARAMS";
        /**
...
(function(CdvPurchase) {
     ...
     */ let LogLevel;
    (function(LogLevel) {
        /** Disable all logging (default) */ LogLevel[LogLevel["QUIET"] = 0] = "QUIET";
        /** Show only error messages */ LogLevel[LogLevel["ERROR"] = 1] = "ERROR";
        /** Show warnings and errors */ LogLevel[LogLevel["WARNING"] = 2] = "WARNING";
        /** Also show information messages */ LogLevel[LogLevel["INFO"] = 3] = "INFO";
        /** Enable internal debugging messages. */ LogLevel[LogLevel["DEBUG"] = 4] = "DEBUG";
    })(LogLevel = CdvPurchase.LogLevel || (CdvPurchase.LogLevel = {}));
    ;
    class Logger {
        /** @internal */ constructor(store, prefix = ''){
            /** All log lines are prefixed with this string */ this.prefix = '';
            this.store = store;
         ...
         */ logCallbackException(context, err) {
            ...
            if (typeof err === 'string') this.warn("           " + err);
            else if (err) {
                const errAny = err;
    ...
    function log(verbosity, level, prefix, o) {
        ...
        if (LOG_LEVEL_STRING[level]) logStr(`${fullPrefix}${LOG_LEVEL_STRING[level]}: ${o}`);
        else logStr(`${fullPrefix}${o}`);
    }
})(CdvPurchase || (CdvPurchase = {}));
var CdvPurchase;
(function(CdvPurchase) {
...
var CdvPurchase;
(function(CdvPurchase) {
    /** Product definition from a store */ class Product {
        /** @internal */ constructor(p, decorator){
            /** @internal */ this.className = 'Product';
            /** Product title from the store. */ this.title = '';
            /** Product full description from the store. */ this.description = '';
...
(function(CdvPurchase) {
    let Utils;
    (function(Utils) {
        /** Object.values() for ES6 */ function objectValues(obj) {
            const ret = [];
            for(let key in obj){
...
(function(CdvPurchase) {
    let Utils;
    (function(Utils) {
        /** Returns human format name for a given platform */ function platformName(platform) {
            switch(platform){
...
(function(CdvPurchase) {
     ...
     */ let Internal;
    (function(Internal) {
        /** Queue of receipts to validate */ class ReceiptsToValidate {
            constructor(){
                this.array = [];
            }
            get length() {
        ...
        /** Handles communication with the remote receipt validation service */ class Validator {
            constructor(controller, log){
                /** List of receipts waiting for validation */ this.receiptsToValidate = new ReceiptsToValidate();
                /** List of verified receipts */ this.verifiedReceipts = [];
                this.numRequests = 0;
                this.numResponses = 0;
                /**
            ...
            /** Add/update a verified receipt from the server response */ addVerifiedReceipt(receipt, data) {
            ...
            /** Add a receipt to the validation queue. It'll get validated after a few milliseconds. */ add(receiptOrTransaction) {
            ...
            /** Run validation for all receipts in the queue */ run() {
    ...
    (function(Internal) {
         ...
         */ class StoreAdapterListener {
            constructor(delegate, log){
                /** The list of supported platforms, needs to be set by "store.initialize" */ this.supportedPlatforms = [];
                /** Those platforms have reported that their receipts are ready */ this.platformWithReceiptsReady = [];
                this.lastTransactionState = {};
                /** Store the listener's latest calling time (in ms) for a given transaction at a given state */ this.lastCallTimeForState = {};
    ...
    (function(Internal) {
         ...
         */ class Callbacks {
             ...
             */ constructor(logger, className, finalStateMode = false){
                /** List of registered callbacks */ this.callbacks = [];
                /** Number of times those callbacks have been triggered */ this.numTriggers = 0;
                this.logger = logger;
                this.className = className;
                this.finalStateMode = finalStateMode;
            }
            /** Add a callback to the list */ push(callback, callbackName) {
            ...
            /** Call all registered callbacks with the given value */ trigger(value, reason) {
            ...
            /** Remove a callback from the list */ remove(callback) {
...
(function(CdvPurchase) {
    ...
    (function(Internal) {
         ...
         */ class ReadyCallbacks {
            constructor(logger){
                /** True when the plugin is ready */ this.isReady = false;
                /** Callbacks when the store is ready */ this.readyCallbacks = [];
                this.logger = logger;
            }
            /** Register a callback to be called when the plugin is ready. */ add(cb) {
                if (this.isReady) return setTimeout(cb, 0);
                this.readyCallbacks.push(cb);
            }
            /** Calls the ready callbacks */ trigger(reason) {
                this.isReady = true;
        ...
        class RegisteredProducts {
            ...
            add(product) {
                ...
                for (const p of newProducts){
                    if (isValidRegisteredProduct(p)) this.list.push(p);
                    else errors.push(CdvPurchase.storeError(CdvPurchase.ErrorCode.LOAD, 'Invalid parameter to "register", expected "id", "type" and "platform". ' + 'Got: ' + JSON.stringify(p), null, null));
                }
                return errors;
            }
            byPlatform() {
...
(function(CdvPurchase) {
    ...
    (function(Internal) {
         ...
         */ class ExpiryMonitor {
            /** Track active local transactions */ // activeTransactions: {
            //   [transactionId: string]: true;
            // } = {};
            /** Track notified local transactions */ // notifiedTransactions: {
            //   [transactionId: string]: true;
            // } = {};
            constructor(controller){
                /** Track active verified purchases */ this.activePurchases = {};
                /** Track notified verified purchases */ this.notifiedPurchases = {};
                this.controller = controller;
            }
            launch() {
        ...
        /** Time between checks for newly expired subscriptions */ ExpiryMonitor.INTERVAL_MS = 10000;
        /**
...
(function(CdvPurchase) {
     ...
     */ class Store {
        constructor(){
            ...
            /** Logger */ this.log = new CdvPurchase.Logger(this);
            /**
            ...
            /** List of callbacks for the "ready" events */ this._readyCallbacks = new CdvPurchase.Internal.ReadyCallbacks(this.log);
            /** Callbacks when a product definition was updated */ this.updatedCallbacks = new CdvPurchase.Internal.Callbacks(this.log, 'productUpdated()');
            /** Callback when a receipt was updated */ this.updatedReceiptsCallbacks = new CdvPurchase.Internal.Callbacks(this.log, 'receiptUpdated()');
            /** Callbacks when a product is owned */ // private ownedCallbacks = new Callbacks<Product>();
            /** Callbacks when a transaction is initiated */ this.initiatedCallbacks = new CdvPurchase.Internal.Callbacks(this.log, 'initiated()');
            /** Callbacks when a transaction has been approved */ this.approvedCallbacks = new CdvPurchase.Internal.Callbacks(this.log, 'approved()');
            /** Callbacks when a transaction has been finished */ this.finishedCallbacks = new CdvPurchase.Internal.Callbacks(this.log, 'finished()');
            /** Callbacks when a transaction is pending */ this.pendingCallbacks = new CdvPurchase.Internal.Callbacks(this.log, 'pending()');
            /** Callbacks when a receipt has been validated */ this.verifiedCallbacks = new CdvPurchase.Internal.Callbacks(this.log, 'verified()');
            /** Callbacks when a receipt has been validated */ this.unverifiedCallbacks = new CdvPurchase.Internal.Callbacks(this.log, 'unverified()');
            /** Callbacks when all receipts have been loaded */ this.receiptsReadyCallbacks = new CdvPurchase.Internal.Callbacks(this.log, 'receiptsReady()', true);
            /** Callbacks when all receipts have been verified */ this.receiptsVerifiedCallbacks = new CdvPurchase.Internal.Callbacks(this.log, 'receiptsVerified()', true);
            /** Callbacks for errors */ this.errorCallbacks = new CdvPurchase.Internal.Callbacks(this.log, 'error()');
            this.initializedHasBeenCalled = false;
            /** Stores the last time the store was updated (or initialized), to skip calls in quick succession. */ this.lastUpdate = 0;
            /**
        ...
        */ getApplicationUsername() {
        ...
        /** true if the plugin is initialized and ready */ get isReady() {
        ...
        /** List of all transaction from the local receipts. */ get localTransactions() {
            const ret = [];
        ...
        /** Return true if a product or offer can be purchased */ canPurchase(offer) {
         ...
         */ requestPayment(paymentRequest, additionalData) {
            ...
            if (!adapter) return CdvPurchase.PaymentRequestPromise.failed(CdvPurchase.ErrorCode.PAYMENT_NOT_ALLOWED, 'Adapter not found or not ready (' + paymentRequest.platform + ')', paymentRequest.platform, null);
         ...
         */ finish(receipt) {
            return __awaiter(this, void 0, void 0, function*() {
                ...
                const transactions = receipt instanceof CdvPurchase.VerifiedReceipt ? receipt.sourceReceipt.transactions : receipt instanceof CdvPurchase.Receipt ? receipt.transactions : [
                    receipt
                ];
...
/** @private */ function initCDVPurchase() {
    var _a;
...
var CdvPurchase;
(function(CdvPurchase) {
    /** Types of In-App Products */ let ProductType;
    (function(ProductType) {
        /** Type: An consumable product, that can be purchased multiple time */ ProductType["CONSUMABLE"] = "consumable";
        /** Type: A non-consumable product, that can purchased only once and the user keeps forever */ ProductType["NON_CONSUMABLE"] = "non consumable";
        /** @deprecated use PAID_SUBSCRIPTION */ ProductType["FREE_SUBSCRIPTION"] = "free subscription";
        /** Type: An auto-renewable subscription */ ProductType["PAID_SUBSCRIPTION"] = "paid subscription";
        /** Type: An non-renewing subscription */ ProductType["NON_RENEWING_SUBSCRIPTION"] = "non renewing subscription";
        /** Type: The application bundle */ ProductType["APPLICATION"] = "application";
    ...
    /** Mode of payment */ let PaymentMode;
    (function(PaymentMode) {
        /** Used for subscriptions, pay at the beginning of each billing period */ PaymentMode["PAY_AS_YOU_GO"] = "PayAsYouGo";
        /** Pay the whole amount up front */ PaymentMode["UP_FRONT"] = "UpFront";
        /** Nothing to be paid */ PaymentMode["FREE_TRIAL"] = "FreeTrial";
    })(PaymentMode = CdvPurchase.PaymentMode || (CdvPurchase.PaymentMode = {}));
    /**
     * Purchase platforms supported by the plugin
     */ let Platform;
    (function(Platform) {
        /** Apple AppStore */ Platform["APPLE_APPSTORE"] = "ios-appstore";
        /** Google Play */ Platform["GOOGLE_PLAY"] = "android-playstore";
        /** Windows Store */ Platform["WINDOWS_STORE"] = "windows-store-transaction";
        /** Braintree */ Platform["BRAINTREE"] = "braintree";
        // /** Stripe */
        // STRIPE = 'stripe',
        /** Test platform */ Platform["TEST"] = "test";
    ...
    /** Whether or not the user intends to let the subscription auto-renew. */ let RenewalIntent;
    (function(RenewalIntent) {
        /** The user intends to let the subscription expire without renewing. */ RenewalIntent["LAPSE"] = "Lapse";
        /** The user intends to renew the subscription. */ RenewalIntent["RENEW"] = "Renew";
    })(RenewalIntent = CdvPurchase.RenewalIntent || (CdvPurchase.RenewalIntent = {}));
    /** Whether or not the user was notified or agreed to a price change */ let PriceConsentStatus;
    ...
    /** Reason why a subscription has been canceled */ let CancelationReason;
    (function(CancelationReason) {
        /** Not canceled */ CancelationReason["NOT_CANCELED"] = "";
        /** Subscription canceled by the developer. */ CancelationReason["DEVELOPER"] = "Developer";
        /** Subscription canceled by the system for an unspecified reason. */ CancelationReason["SYSTEM"] = "System";
        /** Subscription upgraded or downgraded to a new subscription. */ CancelationReason["SYSTEM_REPLACED"] = "System.Replaced";
        /** Product not available for purchase at the time of renewal. */ CancelationReason["SYSTEM_PRODUCT_UNAVAILABLE"] = "System.ProductUnavailable";
        /** Billing error; for example customer’s payment information is no longer valid. */ CancelationReason["SYSTEM_BILLING_ERROR"] = "System.BillingError";
        /** Transaction is gone; It has been deleted. */ CancelationReason["SYSTEM_DELETED"] = "System.Deleted";
        /** Subscription canceled by the user for an unspecified reason. */ CancelationReason["CUSTOMER"] = "Customer";
        /** Customer canceled their transaction due to an actual or perceived issue within your app. */ CancelationReason["CUSTOMER_TECHNICAL_ISSUES"] = "Customer.TechnicalIssues";
        /** Customer did not agree to a recent price increase. See also priceConsentStatus. */ CancelationReason["CUSTOMER_PRICE_INCREASE"] = "Customer.PriceIncrease";
        /** Customer canceled for cost-related reasons. */ CancelationReason["CUSTOMER_COST"] = "Customer.Cost";
        /** Customer claimed to have found a better app. */ CancelationReason["CUSTOMER_FOUND_BETTER_APP"] = "Customer.FoundBetterApp";
        /** Customer did not feel he is using this service enough. */ CancelationReason["CUSTOMER_NOT_USEFUL_ENOUGH"] = "Customer.NotUsefulEnough";
        /** Subscription canceled for another reason; for example, if the customer made the purchase accidentally. */ CancelationReason["CUSTOMER_OTHER_REASON"] = "Customer.OtherReason";
        /** Subscription canceled for unknown reasons. */ CancelationReason["UNKNOWN"] = "Unknown";
...
(function(CdvPurchase) {
     ...
     */ class Offer {
        /** @internal */ constructor(options, decorator){
            /** className, used to make sure we're passing an actual instance of the "Offer" class. */ this.className = 'Offer';
            this.id = options.id;
        ...
        /** Identifier of the product related to this offer */ get productId() {
            return '';
        }
        /** Type of the product related to this offer */ get productType() {
            return CdvPurchase.ProductType.APPLICATION;
        }
        /** Group the product related to this offer is member of */ get productGroup() {
            return undefined;
        }
        /** Platform this offer is available from */ get platform() {
            return CdvPurchase.Platform.TEST;
        }
        /**
...
(function(CdvPurchase) {
    class Receipt {
        /** @internal */ constructor(platform, decorator){
            /** @internal */ this.className = 'Receipt';
            /** List of transactions contained in the receipt, ordered by date ascending. */ this.transactions = [];
        ...
        /** Finish all transactions in a receipt */ finish() {
            return __awaiter(this, void 0, void 0, function*() {});
        }
        /** Return true if the receipt contains the given transaction */ hasTransaction(value) {
            return !!this.transactions.find((t)=>t === value);
        }
        /** Return the last transaction in this receipt */ lastTransaction() {
...
(function(CdvPurchase) {
     ...
     */ class Transaction {
        /** @internal */ constructor(platform, parentReceipt, decorator){
            /** @internal */ this.className = 'Transaction';
            /** Transaction identifier. */ this.transactionId = '';
            /** State this transaction is in */ this.state = CdvPurchase.TransactionState.UNKNOWN_STATE;
            /** Purchased products */ this.products = [];
            this.platform = platform;
            Object.defineProperty(this, 'finish', {
                'enumerable': false,
                get () {
...
(function(CdvPurchase) {
    let Internal;
    (function(Internal) {
        /** Analyze the list of local receipts. */ class LocalReceipts {
            /**
             * Find the latest transaction for a given product, from those reported by the device.
            ...
            /** Return true if a product is owned */ static isOwned(localReceipts, product) {
...
(function(CdvPurchase) {
    ...
    (function(Internal) {
        class PromiseLike {
            ...
            /** Add a callback to the list */ push(callback) {
                if (this.resolved) setTimeout(callback, 0, this.resolvedArgument);
                else this.callbacks.push(callback);
            }
            /** Call all registered callbacks with the given value */ resolve(value) {
...
(function(CdvPurchase) {
    let Internal;
    (function(Internal) {
        /** Analyze the list of local receipts. */ class VerifiedReceipts {
            /**
             * Find the last verified purchase for a given product, from those verified by the receipt validator.
            ...
            /** Return true if a product is owned, based on the content of the list of verified receipts  */ static isOwned(verifiedReceipts, product) {
                if (!product) return false;
...
(function(CdvPurchase) {
     ...
     */ let ApplePay;
    (function(ApplePay) {
        /** The fields that describe a contact. */ let ContactField;
        ...
        /** A type that represents a payment method. */ let PaymentNetwork;
        (function(PaymentNetwork) {
            /** An American Express payment card. */ PaymentNetwork["Amex"] = "Amex";
            /** A QR code used for payment. */ PaymentNetwork["Barcode"] = "Barcode";
            /** A Cartes Bancaires payment card. */ PaymentNetwork["CartesBancaires"] = "CartesBancaires";
            /** A China Union Pay payment card. */ PaymentNetwork["ChinaUnionPay"] = "ChinaUnionPay";
            /** The Dankort payment card. */ PaymentNetwork["Dankort"] = "Dankort";
            /** A Discover payment card. */ PaymentNetwork["Discover"] = "Discover";
            /** The electronic funds transfer at point of sale (EFTPOS) payment method. */ PaymentNetwork["Eftpos"] = "Eftpos";
            /** An Electron debit card. */ PaymentNetwork["Electron"] = "Electron";
            /** The Elo payment card. */ PaymentNetwork["Elo"] = "Elo";
            /** A Girocard payment method. */ PaymentNetwork["Girocard"] = "Girocard";
            /** An iD payment card. */ PaymentNetwork["IDCredit"] = "IDCredit";
            /** The Interac payment method. */ PaymentNetwork["Interac"] = "Interac";
            /** A JCB payment card. */ PaymentNetwork["JCB"] = "JCB";
            /** A mada payment card. */ PaymentNetwork["Mada"] = "Mada";
            /** A Maestro payment card. */ PaymentNetwork["Maestro"] = "Maestro";
            /** A MasterCard payment card. */ PaymentNetwork["MasterCard"] = "MasterCard";
            /** A Mir payment card. */ PaymentNetwork["Mir"] = "Mir";
            /** A Nanaco payment card. */ PaymentNetwork["Nanaco"] = "Nanaco";
            /** Store credit and debit cards. */ PaymentNetwork["PrivateLabel"] = "PrivateLabel";
            /** A QUICPay payment card. */ PaymentNetwork["QuicPay"] = "QuicPay";
            /** A Suica payment card. */ PaymentNetwork["Suica"] = "Suica";
            /** A Visa payment card. */ PaymentNetwork["Visa"] = "Visa";
            /** A Visa V Pay payment card. */ PaymentNetwork["VPay"] = "VPay";
            /** A WAON payment card. */ PaymentNetwork["Waon"] = "Waon";
        })(PaymentNetwork = ApplePay.PaymentNetwork || (ApplePay.PaymentNetwork = {}));
        /** Capabilities for processing payment. */ let MerchantCapability;
        (function(MerchantCapability) {
            /** Support for the 3-D Secure protocol. */ MerchantCapability["ThreeDS"] = "3DS";
            /** Support for the EMV protocol. */ MerchantCapability["EMV"] = "EMV";
            /** Support for credit cards. */ MerchantCapability["Credit"] = "Credit";
            /** Support for debit cards. */ MerchantCapability["Debit"] = "Debit";
    ...
    (function(AppleAppStore) {
         ...
         */ class Adapter {
            constructor(context, options){
                ...
                /** List of products loaded from AppStore */ this._products = [];
                this.validProducts = {};
                this._paymentMonitor = ()=>{};
                this.supportsParallelLoading = true;
                /** True iff the appStoreReceipt is already being initialized */ this._appStoreReceiptLoading = false;
                /** List of functions waiting for the appStoreReceipt to be initialized */ this._appStoreReceiptCallbacks = [];
            ...
            /** Find a given product from ID */ getProduct(id) {
            ...
            /** Returns true on iOS, the only platform supported by this adapter */ get isSupported() {
            ...
            /** Remove a transaction from the pseudo receipt */ removeTransactionInProgress(productId) {
                const transactionId = virtualTransactionId(productId);
                this.pseudoReceipt.transactions = this.pseudoReceipt.transactions.filter((t)=>t.transactionId !== transactionId);
            }
            /** Insert or update a transaction in the pseudo receipt, based on data collected from the native side */ upsertTransaction(productId, transactionId, state) {
                return __awaiter(this, void 0, void 0, function*() {
                    return new Promise((resolve)=>{
            ...
            /** Notify the store that the receipts have been updated */ _receiptsUpdated() {
                if (this._receipt) {
                    this.log.debug("receipt updated and ready.");
                    this.context.listener.receiptsUpdated(CdvPurchase.Platform.APPLE_APPSTORE, [
                        this._receipt,
                        this.pseudoReceipt
                    ]);
            ...
            /** Promisified loading of the AppStore receipt */ loadAppStoreReceipt() {
                return __awaiter(this, void 0, void 0, function*() {
                    let resolved = false;
                    return new Promise((resolve)=>{
                        var _a;
            ...
            handleReceiptValidationResponse(_receipt, response) {
                ...
                return __awaiter(this, void 0, void 0, function*() {
                    ...
                    if (localReceiptUpdated) this.context.listener.receiptsUpdated(CdvPurchase.Platform.APPLE_APPSTORE, [
                        _receipt
                    ]);
                });
            }
...
(function(CdvPurchase) {
    ...
    (function(AppleAppStore) {
        let Bridge;
        (function(Bridge_1) {
            /** No-operation function, used as a default for callbacks */ const noop = (args)=>{};
            /** Logger */ let log = noop;
            /** Execute a native method */ function exec(methodName, options, success, error) {
                window.cordova.exec(success, error, "InAppPurchase", methodName, options);
            }
            ;
            /** Execute a javascript-side method in a try-catch block */ function protectCall(callback, context, ...args) {
                if (!callback) {
                    return;
                }
                try {
            ...
            class Bridge {
                constructor(){
                    /** Transactions for a given product */ this.transactionsForProduct = {};
                    /** True when the SDK has been initialized */ this.initialized = false;
                    /** List of registered product identifiers */ this.registeredProducts = [];
                    /** True if "restoreCompleted" or "restoreFailed" should be called when restore is done */ this.needRestoreNotification = false;
                    /*
                    private eventQueue: {
                    ...
                    */ /** List of transaction updates to process */ this.pendingUpdates = [];
                    /** @deprecated */ this.onPurchased = false;
                    /** @deprecated */ this.onFailed = false;
                    /** @deprecated */ this.onRestored = false;
        ...
        class SKProduct extends CdvPurchase.Product {
            ...
            refresh(valid, decorator, eligibilities) {
                 ...
                 */ function formatBillingPeriod(numPeriods, period) {
                    if (numPeriods && period) return `P${numPeriods}${period[0]}`;
...
(function(CdvPurchase) {
    ...
    (function(AppleAppStore) {
        ...
        /** StoreKit transaction */ class SKTransaction extends CdvPurchase.Transaction {
    ...
    (function(AppleAppStore) {
        ...
        (function(VerifyReceipt) {
            ...
            (function(AppleExpirationIntent) {
                /** The customer voluntarily canceled their subscription. */ AppleExpirationIntent["CANCELED"] = "1";
                /** Billing error; for example, the customer"s payment information was no longer valid. */ AppleExpirationIntent["BILLING_ERROR"] = "2";
                /** The customer did not agree to a recent price increase. */ AppleExpirationIntent["PRICE_INCREASE"] = "3";
                /** The product was not available for purchase at the time of renewal. */ AppleExpirationIntent["PRODUCT_NOT_AVAILABLE"] = "4";
                /** Unknown error. */ AppleExpirationIntent["UNKNOWN"] = "5";
    ...
    (function(Braintree) {
        ...
        class Adapter {
                ...
                return new Promise((resolve)=>{
                    ...
                    if (Braintree.IosBridge.Bridge.isSupported()) {
                        ...
                        this.iosBridge = new Braintree.IosBridge.Bridge(this.log, (callback)=>{
                            if (this.options.tokenizationKey) callback(this.options.tokenizationKey);
                            else if (this.options.clientTokenProvider) this.options.clientTokenProvider(callback);
                            else callback(braintreeError(CdvPurchase.ErrorCode.CLIENT_INVALID, 'Braintree iOS Bridge requires a clientTokenProvider or tokenizationKey'));
            ...
            finish(transaction) {
                return __awaiter(this, void 0, void 0, function*() {
                    transaction.state = CdvPurchase.TransactionState.FINISHED;
                    this.context.listener.receiptsUpdated(CdvPurchase.Platform.TEST, [
                        transaction.parentReceipt
                    ]);
                    return;
                });
            ...
            requestPayment(paymentRequest, additionalData) {
                ...
                return __awaiter(this, void 0, void 0, function*() {
                    ...
                    this.context.listener.receiptsUpdated(CdvPurchase.Platform.BRAINTREE, [
                        receipt
                    ]);
    ...
    (function(Braintree) {
        ...
        (function(AndroidBridge) {
             ...
             */ class Bridge {
                ...
                /** Receive asynchronous messages from the native side */ listener(msg) {
                    ...
                    if (this.clientTokenProvider) {
                        ...
                        this.clientTokenProvider((value)=>{
                            if (typeof value === 'string') {
                                window.cordova.exec(null, null, PLUGIN_ID, "onClientTokenSuccess", [
                                    value
                                ]);
                            } else {
                                window.cordova.exec(null, null, PLUGIN_ID, "onClientTokenFailure", [
                                    value.code,
                                    value.message
                                ]);
                            }
                ...
                /** Returns true on Android, the only platform supported by this Braintree bridge */ static isSupported() {
                 ...
                 */ static requestPayment(request) {
                    return new Promise((resolve)=>{
                        ...
                        if (!((_a = ApplePayPlugin.get()) === null || _a === void 0 ? void 0 : _a.installed)) {
                            ...
                            window.cordova.exec(success, failure, PLUGIN_ID, 'presentDropInPaymentUI', [
                                request
                            ]);
                        }
                    });
        ...
        (function(IosBridge) {
            class Bridge {
                ...
                initialize(verbosity, callback) {
                    window.cordova.exec(null, null, "BraintreePlugin", "setVerbosity", [
                        verbosity.verbosity
                    ]);
                    ...
                    return __awaiter(this, void 0, void 0, function*() {
                        const request = ((_b = (_a = this.applePayOptions) === null || _a === void 0 ? void 0 : _a.preparePaymentRequest) === null || _b === void 0 ? void 0 : _b.call(_a, paymentRequest)) || {
                            merchantCapabilities: [
                                CdvPurchase.ApplePay.MerchantCapability.ThreeDS
                            ]
                        };
                ...
                launchDropIn(paymentRequest, dropInRequest) {
                    return new Promise((resolve)=>__awaiter(this, void 0, void 0, function*() {
                            ...
                            this.clientTokenProvider((clientToken)=>{
                                if (typeof clientToken === 'string') window.cordova.exec(onSuccess, onError, "BraintreePlugin", "launchDropIn", [
                                    clientToken,
                                    dropInRequest
                                ]);
                                else resolve(clientToken);
                            });
                        }));
                }
                braintreePlugin() {
...
(function(CdvPurchase) {
    ...
    (function(Braintree) {
        let DropIn;
        (function(DropIn) {
            /** How a field will behave in CardForm. */ let CardFormFieldStatus;
...
(function(CdvPurchase) {
    ...
    (function(Braintree) {
        let DropIn;
        (function(DropIn) {
            /** Payment method used or selected by the user. */ let PaymentMethod;
            (function(PaymentMethod) {
                /** Google only */ PaymentMethod["GOOGLE_PAY"] = "GOOGLE_PAY";
                /** ios only */ PaymentMethod["LASER"] = "LASER";
                /** ios only */ PaymentMethod["UK_MAESTRO"] = "UK_MAESTRO";
                /** ios only */ PaymentMethod["SWITCH"] = "SWITCH";
                /** ios only */ PaymentMethod["SOLOR"] = "SOLO";
                /** ios only */ PaymentMethod["APPLE_PAY"] = "APPLE_PAY";
    ...
    (function(Braintree) {
        ...
        (function(GooglePay) {
            ...
            (function(TotalPriceStatus) {
                /** The total price is not currently known. */ TotalPriceStatus[TotalPriceStatus["NOT_CURRENTLY_KNOWN"] = 1] = "NOT_CURRENTLY_KNOWN";
                /** The total price is an estimate. */ TotalPriceStatus[TotalPriceStatus["ESTIMATED"] = 2] = "ESTIMATED";
                /** The total price is final. */ TotalPriceStatus[TotalPriceStatus["FINAL"] = 3] = "FINAL";
...
(function(CdvPurchase) {
    ...
    (function(Braintree) {
        ...
        (function(ThreeDSecure) {
            /** The account type */ let AccountType;
            ...
            /** The shipping method */ let ShippingMethod;
            (function(ShippingMethod) {
                /** Unspecified */ ShippingMethod[ShippingMethod["UNSPECIFIED"] = 0] = "UNSPECIFIED";
                /** Same say */ ShippingMethod[ShippingMethod["SAME_DAY"] = 1] = "SAME_DAY";
                /** Overnight / Expedited */ ShippingMethod[ShippingMethod["EXPEDITED"] = 2] = "EXPEDITED";
                /** Priority */ ShippingMethod[ShippingMethod["PRIORITY"] = 3] = "PRIORITY";
                /** Ground */ ShippingMethod[ShippingMethod["GROUND"] = 4] = "GROUND";
                /** Electronic delivery */ ShippingMethod[ShippingMethod["ELECTRONIC_DELIVERY"] = 5] = "ELECTRONIC_DELIVERY";
                /** Ship to store */ ShippingMethod[ShippingMethod["SHIP_TO_STORE"] = 6] = "SHIP_TO_STORE";
            })(ShippingMethod = ThreeDSecure.ShippingMethod || (ThreeDSecure.ShippingMethod = {}));
            let Version;
            (function(Version) {
                /** 3DS 1.0 */ Version[Version["V1"] = 0] = "V1";
                /** 3DS 2.0 */ Version[Version["V2"] = 1] = "V2";
...
(function(CdvPurchase) {
    ...
    (function(GooglePlay) {
            ...
            static toState(fromConstructor, state, isAcknowledged, isConsumed) {
                switch(state){
                    ...
                    case GooglePlay.Bridge.PurchaseState.PURCHASED:
                        ...
                        if (isConsumed) return CdvPurchase.TransactionState.FINISHED;
                        else if (isAcknowledged) return CdvPurchase.TransactionState.APPROVED;
                        else if (fromConstructor) return CdvPurchase.TransactionState.INITIATED;
                        else return CdvPurchase.TransactionState.APPROVED;
        ...
        class Receipt extends CdvPurchase.Receipt {
            /** @internal */ constructor(purchase, decorator){
                super(CdvPurchase.Platform.GOOGLE_PLAY, decorator);
                this.transactions = [
                    new Transaction(purchase, this, decorator)
                ];
                this.purchaseToken = purchase.purchaseToken;
                this.orderId = purchase.orderId;
            }
            /** Refresh the content of the purchase based on the native BridgePurchase */ refreshPurchase(purchase) {
                var _a;
        ...
        class Adapter {
            constructor(context, autoRefreshIntervalMillis = 1000 * 3600 * 24){
                /** Adapter identifier */ this.id = CdvPurchase.Platform.GOOGLE_PLAY;
                /** Adapter name */ this.name = 'GooglePlay';
                /** Has the adapter been successfully initialized */ this.ready = false;
                this.supportsParallelLoading = false;
                this._receipts = [];
                /** The GooglePlay bridge */ this.bridge = new GooglePlay.Bridge.Bridge();
                /** Prevent double initialization */ this.initialized = false;
                /** Used to retry failed commands */ this.retry = new CdvPurchase.Internal.Retry();
            ...
            /** List of products managed by the GooglePlay adapter */ get products() {
                return this._products.products;
            }
            get receipts() {
                return this._receipts;
            }
            /** Returns true on Android, the only platform supported by this adapter */ get isSupported() {
                return CdvPurchase.Utils.platformId() === 'android';
            }
            initialize() {
                return __awaiter(this, void 0, void 0, function*() {
            ...
            /** Prepare the list of SKUs sorted by type */ getSkusOf(products) {
                const inAppSkus = [];
                const subsSkus = [];
                for (const product of products){
                    if (product.type === CdvPurchase.ProductType.PAID_SUBSCRIPTION) subsSkus.push(product.id);
                    else inAppSkus.push(product.id);
                }
                return {
                    inAppSkus,
                    subsSkus
            ...
            /** @inheritDoc */ loadProducts(products) {
                return new Promise((resolve)=>{
                    this.log.debug("Load: " + JSON.stringify(products));
                    /** Called when a list of product definitions have been loaded */ const iabLoaded = (validProducts)=>{
                    ...
                    /** Start loading products */ const go = ()=>{
            ...
            /** @inheritDoc */ finish(transaction) {
                return new Promise((resolve)=>{
                    const onSuccess = ()=>{
                        if (transaction.state !== CdvPurchase.TransactionState.FINISHED) {
                            transaction.state = CdvPurchase.TransactionState.FINISHED;
                            this.context.listener.receiptsUpdated(CdvPurchase.Platform.GOOGLE_PLAY, [
                                transaction.parentReceipt
                            ]);
                        }
                        resolve(undefined);
            ...
            /** Called by the bridge when a purchase has been consumed */ onPurchaseConsumed(purchase) {
            ...
            /** Called when the platform reports update for some purchases */ onPurchasesUpdated(purchases) {
            ...
            /** Called when the platform reports some purchases */ onSetPurchases(purchases) {
            ...
            /** Refresh purchases from GooglePlay */ getPurchases() {
                return new Promise((resolve)=>{
            ...
            /** @inheritDoc */ order(offer, additionalData) {
                return __awaiter(this, void 0, void 0, function*() {
                    return new Promise((resolve)=>{
                ...
                const oldReceipt = this._receipts.find((r)=>{
                    return !!r.transactions.find((t)=>{
                        return !!t.products.find((p)=>{
                            ...
                            if (!product) return false;
                            if (!CdvPurchase.Internal.LocalReceipts.isOwned([
                                r
 ...
 */ /*global cordova */ var CdvPurchase;
(function(CdvPurchase) {
    let GooglePlay;
    (function(GooglePlay) {
        /**
        ...
        (function(ProrationMode) {
            /** Replacement takes effect immediately, and the remaining time will be prorated and credited to the user. */ ProrationMode["IMMEDIATE_WITH_TIME_PRORATION"] = "IMMEDIATE_WITH_TIME_PRORATION";
            /** Replacement takes effect immediately, and the billing cycle remains the same. */ ProrationMode["IMMEDIATE_AND_CHARGE_PRORATED_PRICE"] = "IMMEDIATE_AND_CHARGE_PRORATED_PRICE";
            /** Replacement takes effect immediately, and the new price will be charged on next recurrence time. */ ProrationMode["IMMEDIATE_WITHOUT_PRORATION"] = "IMMEDIATE_WITHOUT_PRORATION";
            /** Replacement takes effect when the old plan expires, and the new price will be charged at the same time. */ ProrationMode["DEFERRED"] = "DEFERRED";
            /** Replacement takes effect immediately, and the user is charged full price of new plan and is given a full billing cycle of subscription, plus remaining prorated time from the old plan. */ ProrationMode["IMMEDIATE_AND_CHARGE_FULL_PRICE"] = "IMMEDIATE_AND_CHARGE_FULL_PRICE";
        ...
        (function(ReplacementMode) {
            /** Replacement takes effect immediately, and the remaining time will be prorated and credited to the user. */ ReplacementMode["WITH_TIME_PRORATION"] = "IMMEDIATE_WITH_TIME_PRORATION";
            /** Replacement takes effect immediately, and the billing cycle remains the same. */ ReplacementMode["CHARGE_PRORATED_PRICE"] = "IMMEDIATE_AND_CHARGE_PRORATED_PRICE";
            /** Replacement takes effect immediately, and the new price will be charged on next recurrence time. */ ReplacementMode["WITHOUT_PRORATION"] = "IMMEDIATE_WITHOUT_PRORATION";
            /** Replacement takes effect when the old plan expires, and the new price will be charged at the same time. */ ReplacementMode["DEFERRED"] = "DEFERRED";
            /** Replacement takes effect immediately, and the user is charged full price of new plan and is given a full billing cycle of subscription, plus remaining prorated time from the old plan. */ ReplacementMode["CHARGE_FULL_PRICE"] = "IMMEDIATE_AND_CHARGE_FULL_PRICE";
        ...
        (function(Bridge_2) {
            ...
            class Bridge {
                ...
                load(success, fail, skus, inAppSkus, subsSkus) {
                    ...
                    window.cordova.exec(success, errorCb(fail), "InAppBillingPlugin", "load", [
                        skus,
                        inAppSkus,
                        subsSkus
                    ]);
                ...
                getPurchases(success, fail) {
                    ...
                    return window.cordova.exec(success, errorCb(fail), "InAppBillingPlugin", "getPurchases", [
                        "null"
                    ]);
                }
                ...
                consumePurchase(success, fail, purchaseToken) {
                    ...
                    return window.cordova.exec(success, errorCb(fail), "InAppBillingPlugin", "consumePurchase", [
                        purchaseToken
                    ]);
                }
                acknowledgePurchase(success, fail, purchaseToken) {
                    ...
                    return window.cordova.exec(success, errorCb(fail), "InAppBillingPlugin", "acknowledgePurchase", [
                        purchaseToken
                    ]);
                }
                getAvailableProducts(inAppSkus, subsSkus, success, fail) {
                    ...
                    return window.cordova.exec(success, errorCb(fail), "InAppBillingPlugin", "getAvailableProducts", [
                        inAppSkus,
                        subsSkus
                    ]);
                }
                ...
                launchPriceChangeConfirmationFlow(productId) {
                    return window.cordova.exec(function() {}, function() {}, "InAppBillingPlugin", "launchPriceChangeConfirmationFlow", [
                        productId
                    ]);
                }
            }
    ...
    (function(GooglePlay) {
        ...
        class Products {
            constructor(decorator){
                /** List of products managed by the GooglePlay adapter */ this.products = [];
                /** List of offers managed by the GooglePlay adapter */ this.offers = [];
            ...
            /**  */ addProduct(registeredProduct, vp) {
                ...
                if ('product_format' in vp && vp.product_format === "v12.0") {
                    if (vp.product_type === "subs") this.onSubsV12Loaded(p, vp);
                    else this.onInAppLoaded(p, vp);
                } else {
    ...
    (function(GooglePlay) {
        ...
        (function(PublisherAPI) {
            ...
            (function(GoogleErrorReason) {
                /** The subscription purchase is no longer available for query because it has been expired for too long. */ GoogleErrorReason["SUBSCRIPTION_NO_LONGER_AVAILABLE"] = "subscriptionPurchaseNoLongerAvailable";
                /** The purchase token is no longer valid. */ GoogleErrorReason["PURCHASE_TOKEN_NO_LONGER_VALID"] = "purchaseTokenNoLongerValid";
           ...
           */ let ErrorCode;
            (function(ErrorCode) {
                /** The subscription purchase is no longer available for query because it has been expired for too long. */ ErrorCode[ErrorCode["GONE"] = 410] = "GONE";
         ...
         */ class Adapter {
            ...
            loadProducts(products) {
                return __awaiter(this, void 0, void 0, function*() {
                    return products.map((registerProduct)=>{
                        ...
                        this.context.listener.productsUpdated(CdvPurchase.Platform.TEST, [
                            product
                        ]);
                        return product;
                    });
            ...
            order(offer) {
                return __awaiter(this, void 0, void 0, function*() {
                    ...
                    if ((response === null || response === void 0 ? void 0 : response.toUpperCase()) !== 'Y') return testStoreError(CdvPurchase.ErrorCode.PAYMENT_CANCELLED, 'Purchase flow has been cancelled by the user', offer.productId);
             ...
             */ requestPayment(paymentRequest, additionalData) {
                ...
                return __awaiter(this, void 0, void 0, function*() {
                    ...
                    this.receipts.push(receipt);
                    setTimeout(()=>{
                        this.context.listener.receiptsUpdated(platform, [
                            receipt
                        ]);
                    }, 400);
                    return transaction;
...
(function(CdvPurchase) {
    ...
    (function(Utils) {
        let Ajax;
        (function(Ajax) {
            /** HTTP status returned when a request times out */ Ajax.HTTP_REQUEST_TIMEOUT = 408;
...
(function(CdvPurchase) {
    let Utils;
    (function(Utils) {
        /** @internal */ function delay(fn, milliseconds) {
            return setTimeout(fn, milliseconds);
        }
        Utils.delay = delay;
        /** @internal */ function debounce(fn, milliseconds) {
            return createDebouncer(fn, milliseconds).call;
        }
        Utils.debounce = debounce;
        /** @internal */ function createDebouncer(fn, milliseconds) {
            let timeout = null;
            let waiting = [];
            ...
            return {
                ...
                wait: ()=>new Promise((resolve)=>{
                        if (timeout) waiting.push(resolve);
                        else resolve();
                    })
            };
        }
        Utils.createDebouncer = createDebouncer;
        /** @internal */ function asyncDelay(milliseconds) {
...
(function(CdvPurchase) {
    let Utils;
    (function(Utils) {
        /** Returns an UUID v4. Uses `window.crypto` internally to generate random values. */ function platformId() {
            var _a, _b, _c;
...
(function(CdvPurchase) {
    ...
    (function(Utils) {
        ...
        /** Returns an UUID v4. Uses `window.crypto` internally to generate random values. */ function uuidv4() {
            // @ts-ignore
            return ([
                1e7
    ...
    (function(Validator) {
        ...
        (function(Internal) {
            ...
            function getPrivacyPolicy(store) {
                if (typeof store.validator_privacy_policy === 'string') return store.validator_privacy_policy.split(',');
                else if (isArray(store.validator_privacy_policy)) return store.validator_privacy_policy;
                else return [
                    'analytics',
                    'support',
                    'fraud'
            ...
            function getDeviceInfo(store) {
                ...
                if (allowed('analytics') || allowed('support')) {
                    ...
                    if (ionic && ionic.version) ret.ionic = ionic.version;
...
var CdvPurchase;
(function(CdvPurchase) {
    /** Receipt data as validated by the receipt validation server */ class VerifiedReceipt {
        /**
         * @internal
         */ constructor(receipt, response, decorator){
            var _a;
            /** @internal */ this.className = 'VerifiedReceipt';
            this.id = response.id;
        ...
        /** Platform this receipt originated from */ get platform() {
            return this.sourceReceipt.platform;
        }
        /** Get raw response data from the receipt validation request */ get raw() {
            return {};
        }
        /**
        ...
        /** Finish all transactions in the receipt */ finish() {
            return __awaiter(this, void 0, void 0, function*() {});
        }
    }
...
//# sourceMappingURL=node_modules_cordova-plugin-purchase_www_store_a4c5bce9.js.map