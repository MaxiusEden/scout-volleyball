...
"[project]/node_modules/@capacitor/filesystem/dist/esm/web.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class FilesystemWeb extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$capacitor$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WebPlugin"] {
    constructor(){
        super(...arguments);
        this.DB_VERSION = 1;
        this.DB_NAME = 'Disc';
         ...
         */ this.downloadFile = async (options)=>{
            var _a, _b;
            const requestInit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$capacitor$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildRequestInit"])(options, options.webFetchExtra);
     ...
     */ async readdir(options) {
        ...
        const files = await Promise.all(entries.map(async (e)=>{
            ...
            if (subEntry === undefined) {
                subEntry = await this.dbRequest('get', [
                    e + '/'
                ]);
            }
            return {
     ...
     */ async getUri(options) {
        ...
        if (entry === undefined) {
            entry = await this.dbRequest('get', [
                path + '/'
            ]);
        }
        return {
            ...
            case 'file':
                {
                    ...
                    if (!(file.data instanceof Blob) && !this.isBase64String(file.data)) {
                        encoding = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$capacitor$2f$filesystem$2f$dist$2f$esm$2f$definitions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Encoding"].UTF8;
                    }
...
//# sourceMappingURL=node_modules_%40capacitor_filesystem_dist_esm_web_806388db.js.map