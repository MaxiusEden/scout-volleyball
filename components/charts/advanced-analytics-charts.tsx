...
function AdvancedAnalyticsCharts({ actions, teamAName, teamBName, sets }: AdvancedAnalyticsChartsProps) {
    ...
    <div className="w-full space-y-6 p-6 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 min-h-screen">
      <div className="flex gap-3 justify-center flex-wrap">
        <Button
          ...
          className="font-semibold px-4 py-3 min-w-[120px] rounded-lg transition-all hover:shadow-lg whitespace-nowrap"
        >
          Todos os Sets
        </Button>
        {sets &&
          sets.map((set, idx) => (
            <Button
              ...
              className="font-semibold px-4 py-3 min-w-[80px] rounded-lg transition-all hover:shadow-lg whitespace-nowrap"
            >
              Set {idx + 1}
            </Button>
          ))}
      ...
      <div className="flex gap-3 justify-center flex-wrap">
        <Button
          ...
          className="font-semibold px-6 py-3 min-w-[100px] rounded-lg transition-all hover:shadow-lg whitespace-nowrap"
        >
          {teamAName}
        </Button>
        <Button
...
export default memo(AdvancedAnalyticsCharts)
