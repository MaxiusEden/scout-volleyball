...
export default function Face12Transition({ onSelect }: Face12TransitionProps) {
  ...
  return (
    <div className="space-y-4">
      <div className="mb-6">
        <h2 className="text-xl font-bold text-black mb-2">Tipo de Transição</h2>
        <p className="text-sm text-slate-900 mb-4">Selecione o tipo de transição para encerrar a ação</p>
      </div>
